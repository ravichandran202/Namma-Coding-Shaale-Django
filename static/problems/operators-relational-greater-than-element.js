module.exports =  {
  "title": "Greater Number Checker",
  "difficulty": "easy",
  "acceptance": "99.6%",

  "description": `
    <p>Write a program that reads two numbers and prints True if the first number is greater than the second, otherwise False.</p>
    <p><b>Requirements:</b></p>
    <ul>
      <li>Read two integer inputs</li>
      <li>Check if first number is greater than second using comparison operator</li>
      <li>If greater, print True</li>
      <li>If not greater, print False</li>
    </ul>
    <p>This problem teaches the 'greater than' comparison operation and boolean logic in programming.</p>
  `,
