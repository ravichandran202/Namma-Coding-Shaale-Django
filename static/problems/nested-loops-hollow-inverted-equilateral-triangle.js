module.exports = {
  "title": "Star Pattern – Hollow Equilateral Triangle",
  "difficulty": "hard",
  "acceptance": "83%",

  "description": `
    <p>Print a hollow equilateral triangle pattern using stars. Only the outer boundary of the triangle is filled with stars, while the interior remains empty.</p>
    ...
    <ul>
      ...
      <li>The triangle increases in width from top to bottom</li>
      <li>Each row has decreasing leading spaces</li>
      <li>Only the perimeter is visible as stars</li>
    </ul>
    <p>This creates an equilateral triangle outline where only the border is filled with stars.</p>
  `,
...
Output: 
******* \n *   * \n  * * \n   *</pre>
    <p><b>Explanation:</b> A 4-row hollow equilateral triangle with only the border filled with stars.</p>
  `,
